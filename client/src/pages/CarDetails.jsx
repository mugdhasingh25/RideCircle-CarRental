...
const PaymentForm = ({ carId, pickupDate, returnDate, onSuccess, onCancel }) => {
                    ...
                    <>
                        ...
                        <div className='bg-gray-50 rounded-lg p-4 mb-6 space-y-2'>
                            <div className='flex justify-between text-sm text-gray-600'>
                                ...
                                <span>{currency}{paymentInfo.bookingPrice}</span>
                            </div>
                            ...
                            <div className='flex justify-between text-sm font-semibold text-gray-800 border-t pt-2'>
                                <span>Total</span>
                                <span>{currency}{paymentInfo.totalAmount}</span>
                            </div>
                            {paymentInfo.securityDeposit > 0 && (
                        ...
                        <form onSubmit={handlePayment} className='space-y-4'>
                            ...
                            >
                                ...
                                ) : `Pay ${currency}${paymentInfo.totalAmount}`}
                            </button>
                        </form>
                    </>
                ) : (
